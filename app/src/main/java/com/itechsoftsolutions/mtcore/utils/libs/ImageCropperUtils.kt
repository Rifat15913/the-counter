package com.itechsoftsolutions.mtcore.utils.libs
...
import com.itechsoftsolutions.mtcore.utils.libs.ImageCropperUtils.mCroppedImage
import com.itechsoftsolutions.mtcore.utils.libs.ImageCropperUtils.mListener
...
object ImageCropperUtils {
            ...
            UCrop.REQUEST_CROP -> {
                if (resultCode == Activity.RESULT_OK) {
                    if (data != null) {
                        ...
                        if (croppedImageUri != null && mCroppedImage != null) {
                            mListener?.onSuccess(croppedImageUri, mCroppedImage!!)
                        } else {
     ...
     * */
    interface Listener {
        fun onSuccess(imageUri: Uri, imageFile: File)
